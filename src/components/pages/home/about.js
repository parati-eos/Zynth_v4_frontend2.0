      ...
      <section className="about"  >
                ...
                <div className="about-info">
                    ...
                    <div style={{ marginTop: '-2rem',fontFamily: 'Poppins, sans-serif' }}>
                        ...
                        We have launched the first product on Zynth which automates the development of an investor deck by collecting a few details around the startup and running them through its proprietary algorithms to generate an investor-ready on-brand pitch deck.<br/><br/>
                        Zynth is the result of years of experience in crafting pitch decks for early and growth-stage startups, combined with extensive market research and business planning expertise.
                        </p>

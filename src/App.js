...
import ApplicationLanding from './components/pages/js/applicationLanding.js'
import FormPage from './components/pages/js/form.js'
import PresentationCheck from './components/pages/js/presentationcheck.js'
import ReviewResponses from './components/pages/js/ReviewResponses.js'
import History from './components/pages/js/presentationhistory.js'
...
import Presentationedit from './components/pages/js/Presentationedit.js'
import PaymentSuccess from './components/pages/Payment/Payment_success.js'
import ConciseForm from './components/pages/conciseForm/form.js'
import SectionForm from './components/pages/sectionForm/sectionForm.js'
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/sectionForm"
          element={<SectionForm Title="Financials" />}
        />
        <Route path="/auth/login" element={<Login />} />
        <Route path="/form" element={<FormPage />} />
        <Route path="/applicationLanding" element={<ApplicationLanding />} />
        <Route
          path="/Pages/presentationcheck"
          element={<PresentationCheck />}
        />
